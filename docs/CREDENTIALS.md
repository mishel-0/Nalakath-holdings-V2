...
- **Role:** Admin
- **Email:** `admin@nalakath.com`
- **Password:** `AdminPassword123!`
- **Capabilities:** Full system access, including Projects, Assets, Loans, and User Management.

## 2. Accountant Account (Hafees)
- **Role:** Accountant
- **Email:** `hafees@nalakath.com`
