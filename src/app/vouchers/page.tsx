        ...
        <div className="flex flex-col gap-8 max-w-7xl mx-auto">
          <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <Button variant="outline" className="rounded-full gap-2 border-white/10 glass-hover h-11 px-6 shadow-sm" onClick={handleExportCSV}>
          ...
          <Card className="gold-glass control-center-card overflow-hidden rounded-[2rem]">
                ...
                <TableBody>
                  {isLoading ? (
                    ...
                    filteredVouchers.map((v) => (
                      <TableRow key={v.id} className="border-white/5 glass-hover ios-transition group">
...
function StatCard({ title, value, color = "text-foreground", icon: Icon }: any) {
  return (
    <Card className="gold-glass control-center-card min-w-0 overflow-hidden group glass-hover smooth-spring">
