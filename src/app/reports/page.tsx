    ...
    <main className="flex-1 px-4 py-8 md:pl-80 md:pr-12 md:pt-32 mb-24 md:mb-0 overflow-hidden relative">
      <div className="absolute inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/20 pointer-events-none">
        <div className="glass curvy p-8 text-center border-primary/20 shadow-2xl shadow-primary/10 pointer-events-auto">
          <BarChart3 className="h-12 w-12 text-primary mx-auto mb-4 animate-bounce" />
          <h2 className="text-2xl font-black uppercase tracking-widest mb-2">Reports Hub</h2>
          <p className="text-muted-foreground text-xs uppercase tracking-[0.2em] font-bold">Deploying Intelligence • Coming Soon</p>
        </div>
      </div>
      <div className="flex flex-col gap-8 max-w-7xl mx-auto opacity-20 grayscale pointer-events-none">
        ...
        <Tabs defaultValue="p&l" className="w-full" onValueChange={setActiveTab}>
          ...
          <TabsContent value="p&l" className="space-y-6 animate-in fade-in duration-500">
            ...
            <Card className="gold-glass control-center-card border-white/5 h-[450px]">
              <CardHeader>
          ...
          <TabsContent value="gst" className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid gap-8 lg:grid-cols-5">
              <Card className="lg:col-span-3 gold-glass control-center-card min-w-0">
              ...
              <div className="lg:col-span-2 space-y-6">
                <Card className="gold-glass control-center-card border-primary/20 bg-primary/5 min-w-0">
                  <CardHeader>
                ...
                <Card className="gold-glass control-center-card border-white/5">
                  <CardHeader>
...
function ReportSummaryCard({ title, value, trend, highlight }: any) {
  return (
    <Card className={cn("gold-glass control-center-card border-white/5 min-w-0", highlight && "ring-1 ring-primary/20")}>
...
function GSTMetricCard({ title, value, sub, color = "text-foreground", highlight }: any) {
  return (
    <Card className={cn("gold-glass control-center-card border-white/5 min-w-0", highlight && "ring-1 ring-primary/20 bg-primary/5")}>
