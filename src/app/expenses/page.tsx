            ...
            <Card className="w-full max-w-4xl bg-[#FDFBF7] text-[#0C0A07] overflow-hidden rounded-none print:shadow-none shadow-2xl relative animate-in zoom-in-95 duration-300 font-sans border-none">
              ...
              <div className="p-10 md:p-12 pb-6 space-y-8">
                <div className="grid grid-cols-2 gap-12">
                  <div className="rounded-lg overflow-hidden border border-[#CEBB8A] bg-[#FDFBF7]">
                    ...
                    <div className="p-4 grid grid-cols-2 gap-y-3 text-[11px]">
                      <span className="font-bold text-[#6B5C42] uppercase">Invoice Number:</span><span className="font-black text-[#0C0A07]">{invoiceToPrint.invoiceNumber || 'NC-2025-0042'}</span>
                      <span className="font-bold text-[#6B5C42] uppercase">Invoice Date:</span><span className="font-black text-[#0C0A07]">{new Date(invoiceToPrint.expenseDate).toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}</span>
                      <span className="font-bold text-[#6B5C42] uppercase">Payment Terms:</span><span className="font-black text-[#0C0A07]">Net 30 Days</span>
                    </div>
                  </div>
                  <div className="rounded-lg overflow-hidden border border-[#CEBB8A] bg-[#FDFBF7]">
                    ...
                    <div className="p-4">
                      <p className="text-lg font-black text-[#0C0A07] uppercase mb-2">{invoiceToPrint.clientName}</p>
                      <p className="text-[11px] font-bold text-[#6B5C42] uppercase">{invoiceToPrint.clientGstin ? `GSTIN: ${invoiceToPrint.clientGstin}` : "Infrastructure Development Unit"}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-[#181410] rounded-lg px-6 py-2.5 flex gap-4 items-center border-l-[6px] border-[#C9A84C]">
                  ...
                  <p className="text-xs font-bold text-[#F5EDD6] uppercase truncate">{currentInvoicePhase?.name || 'HQ Operations'}: {invoiceToPrint.description}</p>
                </div>
                ...
                <div className="overflow-hidden rounded-lg border border-[#CEBB8A]">
                  <table className="w-full text-left border-collapse">
                    <thead className="bg-[#0C0A07] text-[#C9A84C]">
                      <tr>
                        <th className="py-3 px-4 text-[9px] font-black uppercase tracking-widest border-r border-white/10 text-center w-12">#</th>
                    ...
                    <tbody className="divide-y divide-[#E0D4B0]">
                      <tr className="bg-white">
                        <td className="p-4 text-xs font-black text-[#6B5C42] text-center border-r border-[#F7F2E8]">1</td>
                        <td className="p-4 border-r border-[#F7F2E8] text-xs font-black text-[#0C0A07] uppercase">{invoiceToPrint.description}</td>
                        <td className="p-4 text-center text-xs font-mono text-[#0C0A07] border-r border-[#F7F2E8]">9954</td>
                        <td className="p-4 text-center text-xs font-black border-r border-[#F7F2E8]">1 L.S.</td>
                ...
                <div className="flex justify-end mt-6">
                  <div className="w-96 space-y-2">
                    <div className="flex justify-between text-[11px] font-bold px-4"><span className="text-[#6B5C42] uppercase tracking-widest">Subtotal (before GST)</span><span className="font-mono">Rs. {indianNumberFormat(calcs.subtotal)}</span></div>
                    <div className="flex justify-between text-[11px] font-bold px-4"><span className="text-[#6B5C42] uppercase tracking-widest">CGST (9%)</span><span className="font-mono">Rs. {indianNumberFormat(calcs.cgst)}</span></div>
                    <div className="flex justify-between text-[11px] font-bold px-4"><span className="text-[#6B5C42] uppercase tracking-widest">SGST (9%)</span><span className="font-mono">Rs. {indianNumberFormat(calcs.sgst)}</span></div>
                    <div className="flex justify-between text-[11px] font-bold px-4 border-b border-[#E0D4B0] pb-3 text-destructive"><span className="uppercase tracking-widest">TDS (Sec. 194C)</span><span className="font-mono">- Rs. {indianNumberFormat(calcs.tds)}</span></div>
                    <div className="bg-[#0C0A07] p-5 rounded-lg text-[#C9A84C] flex justify-between items-center shadow-lg border-l-[8px] border-[#C9A84C]">
                      <div className="space-y-1"><p className="text-[10px] font-black uppercase tracking-[0.2em]">TOTAL AMOUNT PAYABLE</p><p className="text-3xl font-black tracking-tighter text-[#DFC06A]">Rs. {indianNumberFormat(calcs.totalPayable)}</p></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-12 pt-4">
                  <div className="rounded-lg overflow-hidden border border-[#CEBB8A] bg-[#FDFBF7]">
                    ...
                    <div className="p-4 grid grid-cols-2 gap-y-2 text-[11px]">
                      <span className="font-bold text-[#6B5C42]">Bank:</span><span className="font-black text-[#0C0A07]">State Bank of India</span>
                      <span className="font-bold text-[#6B5C42]">Account No.:</span><span className="font-black text-[#0C0A07] font-mono">32XXXXXXXXXX51</span>
                      <span className="font-bold text-[#6B5C42]">IFSC Code:</span><span className="font-black text-[#0C0A07] font-mono">SBIN0001234</span>
                    </div>
                  </div>
